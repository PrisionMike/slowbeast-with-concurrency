...
fun t_fun(a8)
  ...
  store (32b)x33 to (*)x31 
   ...
   ; dbgloc : ('.file.under.test.i', 686, 3)
  x35: 32b = call pthread_mutex_unlock((*)g1) 
   ; llvm :   ret i8* null, !dbg !68
   ; dbgloc : ('.file.under.test.i', 687, 3)
  ret (*)ptr(0:64b, 0:64b) 
...
fun main()
  ...
  store (32b)0:32b to (*)x38 
   ...
   ; dbgloc : ('.file.under.test.i', 692, 11)
  store (*)g4 to (*)g6 
   ; llvm :   store i32* @g, i32** @g1, align 8, !dbg !69
   ; dbgloc : ('.file.under.test.i', 692, 6)
  store (*)g4 to (*)g2 
